...
# Prediction
	# python -m cellpose --dir "test" --pretrained_model tuning/models
#cellpose_residual_on_style_on_concatenation_off_train4_seed3_2022_06_27_09_18_42.784391 --chan 1 --chan2 0 --diameter 0.0 --flow_threshold 0.5 --cellprob_threshold -2 --save_png --verbose --use_gpu
