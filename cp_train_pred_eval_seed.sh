...
python -m cellpose --dir "testimages$1"  --save_png --verbose --use_gpu --diameter 0  --pretrained_model $(find models$1 -type f -printf "%T@ %p\n" | sort -n | cut -d' ' -f 2- | tail -n 1); python ../../pred_processing.py $1 |& tee -a csi.txt
