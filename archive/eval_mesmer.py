...
# Prediction
# Pretrained CytoplasmSegmentation model (CD3)
from deepcell.applications import CytoplasmSegmentation
app = CytoplasmSegmentation()
masks = app.predict(X_test, image_mpp=5)
np.save('/home/shan/kdata/256x256/M872956_Position8_CD3_img_patch256x256_masks_1ch_mpp05', masks[0]) # save masks as .npy file

# Pretrained Mesmer model (DAPI + CD3)
...
# Newly trained model on CD3 image
'''
...
masks_true = io.imread('/home/shan/kdata/256x256/M872956_Position8_CD3_masks_patch256x256.png')
masks_pred = np.load('/home/shan/kdata/256x256/M872956_Position8_CD3_img_patch256x256_masks_1ch.npy') # csi=0.006
masks_pred = np.load('/home/shan/kdata/256x256/M872956_Position8_CD3_img_patch256x256_masks_cd3_trained.npy') # csi=0.031
