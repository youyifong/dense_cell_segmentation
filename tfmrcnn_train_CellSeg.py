...
from tfmrcnn_NucleusDataset import NucleusDataset
from tfmrcnn_config_nucleus import NucleusConfig, NucleusInferenceConfig
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        default="/fh/fast/fong_y/Kaggle_2018_Data_Science_Bowl_Stage1/",
